...
export class ExerciseFilterQueryDto extends PaginationQueryDto {
  @ApiPropertyOptional({
    description:
      'Filter out exercises with these contraindication slugs (comma-separated)',
  ...
  @ApiPropertyOptional({
    description:
      'Filter by equipment slugs, ordered by preference (comma-separated, first = most preferred)',
