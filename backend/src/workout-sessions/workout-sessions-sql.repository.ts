...
function toSet(r: SetRow): WorkoutSessionSet {
  return {
    ...
    actualWeightKg: r.actual_weight_kg ?? undefined,
    actualReps: r.actual_reps ?? undefined,
    actualDurationSec: r.actual_duration_sec ?? undefined,
    actualDistanceM: r.actual_distance_m ?? undefined,
    actualRpe: r.actual_rpe ?? undefined,
